...
2. System Admin
3. Software development, mostly Python and little PHP
4. WordPress maintenance (performance & security)
5. Cloudflare, Fastly, and other CDNs
6. Site reliability and performnance

# Interests
1. CMS (WordPress, MovableType)
